...
#define COPYRIGHT_HOLDERS "The %s Association"

/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Association"
...
/* Build production */
/* #undef IS_PRODUCTION_BUILD */

/* Define to the sub-directory where libtool stores uninstalled libraries. */
#define LT_OBJDIR ".libs/"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "https://github.com/bitcoin-sv/bitcoin-sv/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitcoin SV"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoin SV 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoin-sv"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitcoinsv.io/"
